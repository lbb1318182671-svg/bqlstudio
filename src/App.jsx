...
const FACADES = [
  { id:"F1", title:"Perforated Steel Screen", layers:["Outer Perforated Steel Panel","Air Cavity + Drainage","Rigid Insulation Board","Vapour Control Layer","Structural Concrete Wall","Interior Plaster Finish"] },
  { id:"F2", title:"Glazed Curtain Wall", layers:["Double-Glazed Unit (6/16/6)","Aluminium Frame","Thermally Broken Mullion","Fire-Stop Barrier","Spandrel Panel","Interior Finish"] },
  { id:"F3", title:"Brick Rain-Screen", layers:["Facing Brick (100mm)","Open Cavity","Stainless Steel Ties","Breather Membrane","Rigid Insulation","Structural Frame"] },
